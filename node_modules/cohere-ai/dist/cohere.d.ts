...
interface CohereService {
    ...
    similarity(model: string, config: models.similarity): Promise<models.cohereResponse<models.similarities>>;
    ...
    likelihood(model: string, config: models.likelihood): Promise<models.cohereResponse<models.token_likelihoods>>;
}
